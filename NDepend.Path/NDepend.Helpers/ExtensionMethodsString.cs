...
namespace NDepend.Helpers {
   ...
   public static class ExtensionMethodsString {
      ...
      public static bool EqualsAny(this string thisString, string str0, string str1, string str2, string str3, string str4, params string[] array) {
         ...
         if (thisString == str0 || thisString == str1 || thisString == str2 || thisString == str3 || thisString == str4) { return true; }
         var length = array.Length;
         for (var i = 0; i < length; i++) {
            if (thisString == array[i]) { return true; }
         }
         return false;
      }
      ...
      ///<remarks>This <see cref="EqualsAny(string,string,string)"/> overload can be used to check the value of <paramref name="thisString"/> against a large number of strings, in a constant time.</remarks>
      ///<param name="thisString">This string.</param>
      ...
      public static bool StartsWithAny(this string thisString, string str0, string str1, string str2, string str3, string str4) {
         ...
         Contract.Requires(str3 != null, "str3 must not be null");
         Contract.Requires(str4 != null, "str4 must not be null");
         return thisString.StartsWith(str0) || thisString.StartsWith(str1) || thisString.StartsWith(str2) || thisString.StartsWith(str3) || thisString.StartsWith(str4);
      }
      ...
      public static bool StartsWithAny(this string thisString, string str0, string str1, string str2, string str3, string str4, params string[] array) {
         ...
         Contract.Requires(str4 != null, "str4 must not be null");
         Contract.Requires(array != null, "strs must not be null");
         if (thisString.StartsWith(str0) || thisString.StartsWith(str1) || thisString.StartsWith(str2) || thisString.StartsWith(str3) || thisString.StartsWith(str4)) { return true; }
         var length = array.Length;
         for (var i = 0; i < length; i++) {
            var str = array[i];
            if (str == null) { throw new NullReferenceException("null string reference in array not accepted."); }
            if (thisString.StartsWith(array[i])) { return true; }
         }
         return false;
      }
      ...
      public static bool EndsWithAny(this string thisString, string str0, string str1, string str2, string str3, string str4) {
         ...
         Contract.Requires(str3 != null, "str3 must not be null");
         Contract.Requires(str4 != null, "str4 must not be null");
         return thisString.EndsWith(str0) || thisString.EndsWith(str1) || thisString.EndsWith(str2) || thisString.EndsWith(str3) || thisString.EndsWith(str4);
      }
      ...
      public static bool EndsWithAny(this string thisString, string str0, string str1, string str2, string str3, string str4, params string[] array) {
         ...
         Contract.Requires(str4 != null, "str4 must not be null");
         Contract.Requires(array != null, "strs must not be null");
         if (thisString.EndsWith(str0) || thisString.EndsWith(str1) || thisString.EndsWith(str2) || thisString.EndsWith(str3) || thisString.EndsWith(str4)) { return true; }
         var length = array.Length;
         for (var i = 0; i < length; i++) {
            var str = array[i];
            if (str == null) { throw new NullReferenceException("null string reference in array not accepted."); }
            if (thisString.EndsWith(array[i])) { return true; }
         }
         return false;
      }
   }
