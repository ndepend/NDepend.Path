   ...
   partial class PathHelpers {
      ...
      static class UNCPathHelper {
         ...
         internal static bool IsAnAbsoluteUNCPath(string pathStringNormalized, out int endIndexServerShare) {
            ...
            if (pathStringNormalized.Length < 5) { return false; }
            ...
            if (server == AbsoluteRelativePathHelpers.CURRENT_DIR_SINGLEDOT) { return false; }
            if (server == AbsoluteRelativePathHelpers.PARENT_DIR_DOUBLEDOT) { return false; }
            ...
            if (share == AbsoluteRelativePathHelpers.CURRENT_DIR_SINGLEDOT) { return false; }
            if (share == AbsoluteRelativePathHelpers.PARENT_DIR_DOUBLEDOT) { return false; }
