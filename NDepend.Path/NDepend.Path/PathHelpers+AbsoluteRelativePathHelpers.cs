...
namespace NDepend.Path {
   ...
   PathTo   = """ + pathTo.ToString() + @"""";
         ...
         private static string GetPathRelativeTo(string pathFrom, string pathTo) {
            ...
            string[] pathFromDirs = pathFrom.Split(MiscHelpers.DIR_SEPARATOR_CHAR);
            string[] pathToDirs = pathTo.Split(MiscHelpers.DIR_SEPARATOR_CHAR);
   ...
   PathTo   = """ + pathTo + @"""";
            ...
            string partExtractedFromPathFrom = String.Join(MiscHelpers.DIR_SEPARATOR_STRING, dirsExtractedFromPathFrom);
            ...
            string partExtractedFromPathTo = String.Join(MiscHelpers.DIR_SEPARATOR_STRING, dirsExtractedFromPathTo);
         ...
         internal static bool IsARelativePath(string pathStringNormalized) {
            ...
            if (secondChar == MiscHelpers.DIR_SEPARATOR_CHAR) { return true; }
            if (secondChar != '.') { return false; }
            if (pathStringNormalized.Length == 2) { return true; }
         ...
         internal static bool TryResolveInnerSpecialDir(string pathStringNormalized, out string pathResolved, out string failureReason) {
            ...
            //
            string[] pathDirs = pathStringNormalized.Split(MiscHelpers.DIR_SEPARATOR_CHAR);
         ...
         private static TryResolveInnerSpecialDirResult TryResolveInnerSpecialDirAlgo(
            ...
            bool bANormalDirHasAlreadyBeenFound = false;
