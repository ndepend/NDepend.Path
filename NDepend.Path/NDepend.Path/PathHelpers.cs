   ...
   public static partial class PathHelpers {
      ...
      public static bool IsValidPathVariableName(this string pathVariableName) {
         ...
         for (var i = 0; i < length; i++) {
            ...
            if (MiscHelpers.IsCharLetterOrDigitOrUnderscore(c)) { continue; }
            return false;
         }
         return true;
      }
      ...
      public static bool IsValidPathVariableValue(this string pathVariableValue) {
         ...
         if (pathVariableValue.IndexOfAny(s_ForbiddenCharInPath) >= 0) { return false; }
      ...
      private static void EventuallyThrowExOnPathStringNullOrEmpty(this string pathString) {
         ...
         if (pathString.Length == 0) { throw new ArgumentException(FAILURE_PATHSTRING_IS_EMPTY, "pathString"); }
      }
      ...
      private static bool TryGetNotNullNormalizedPath(this string pathString, out string pathStringNormalized, out string failureReason) {
         ...
         if (pathString == null) { failureReason = FAILURE_PATHSTRING_IS_NULL; return false; }
         if (pathString.Length == 0) { failureReason = FAILURE_PATHSTRING_IS_EMPTY; return false; }

         var pathStringNormalizedTmp = MiscHelpers.NormalizePath(pathString);
         if (pathStringNormalizedTmp.Length == 0) { failureReason = FAILURE_PATHSTRING_NORMALIZED_IS_EMPTY; return false; }
         failureReason = null;
      ...
      ///<remarks>
      ///The path represented by this string doesn't need to exist for this operation to complete properly.
      ///The method <see cref="IsValidAbsoluteDirectoryPath(string)"/> can be called to enfore <paramref name="pathString"/> validity before calling this method, and avoid any exception.
      ///</remarks>
      ///<param name="pathString">Represents the path.</param>
      ///<exception cref="ArgumentNullException"><paramref name="pathString"/> is null.</exception>
      ...
      ///The path represented by this string doesn't need to exist for this operation to complete properly.
      ///The environment variable prefixing the path doesn't need to exist for this operation to complete properly.
      ///The method <see cref="IsValidEnvVarDirectoryPath(string)"/> can be called to enfore <paramref name="pathString"/> validity before calling this method, and avoid any exception.
      ///</remarks>
      ///<param name="pathString">Represents the path.</param>
      ///<exception cref="ArgumentNullException"><paramref name="pathString"/> is null.</exception>
      ...
      ///<remarks>
      ///The path represented by this string doesn't need to exist for this operation to complete properly.
      ///The method <see cref="IsValidFilePath(string)"/> can be called to enfore <paramref name="pathString"/> validity before calling this method, and avoid any exception.
      ///</remarks>
      ///<param name="pathString">Represents the path.</param>
      ///<exception cref="ArgumentNullException"><paramref name="pathString"/> is null.</exception>
...
" + failureReason;
      ...
      ///</summary>
      ///<remarks>
      ///If this method returns true, the extension method <see cref="ToDirectoryPath(string)"/> can be safely invoked on this string to obtain a <see cref="IDirectoryPath"/>.
      ///Notice that this method can return true even if the path represented by this string doesn't exist.
      ///</remarks>
      ///<param name="pathString">This string from which is determined the path validity.</param>
      ///<returns>
      ...
      public static bool IsValidDirectoryPath(this string pathString, out string failureReason) {
         ...
         if (pathStringNormalized.IsValidRelativeDirectoryPath()) { return true; }
         if (pathStringNormalized.IsValidAbsoluteDirectoryPath()) { return true; }
         if (pathStringNormalized.IsValidEnvVarDirectoryPath()) { return true; }
      ...
      ///</summary>
      ///<remarks>
      ///If this method returns true, the extension method <see cref="ToAbsoluteDirectoryPath(string)"/> can be safely invoked on this string to obtain a <see cref="IAbsoluteDirectoryPath"/>.
      ///Notice that this method can return true even if the path represented by this string doesn't exist.
      ///</remarks>
      ///<param name="pathString">This string from which is determined the path validity.</param>
      ///<returns>
      ...
      public static bool IsValidAbsoluteDirectoryPath(this string pathString, out string failureReason) {
         ...
         if (!AbsoluteRelativePathHelpers.IsAnAbsoluteDriveLetterPath(pathStringNormalized)) {
            if (!UNCPathHelper.IsAnAbsoluteUNCPath(pathStringNormalized)) {
               failureReason = @"The parameter pathString is not an absolute directory path because it doesn't have a drive letter syntax (like ""C:\"") nor a URN path syntax (like ""\\server\share\"").";
               return false;
            }
         }
      ...
      ///</summary>
      ///<remarks>
      ///If this method returns true, the extension method <see cref="ToRelativeDirectoryPath(string)"/> can be safely invoked on this string to obtain a <see cref="IRelativeDirectoryPath"/>.
      ///</remarks>
      ///<param name="pathString">This string from which is determined the path validity.</param>
      ///<returns>
      ...
      ///</summary>
      ///<remarks>
      ///If this method returns true, the extension method <see cref="ToVariableDirectoryPath(string)"/> can be safely invoked on this string to obtain a <see cref="IVariableDirectoryPath"/>.
      ///</remarks>
      ///<param name="pathString">This string from which is determined the path validity.</param>
      ///<returns>
      ...
      ///</summary>
      ///<remarks>
      ///If this method returns true, the extension method <see cref="ToAbsoluteFilePath(string)"/> can be safely invoked on this string to obtain a <see cref="IAbsoluteFilePath"/>.
      ///Notice that this method can return true even if the path represented by this string doesn't exist.
      ///</remarks>
      ///<param name="pathString">This string from which is determined the path validity.</param>
      ///<returns>
      ...
      ///</summary>
      ///<remarks>
      ///If this method returns true, the extension method <see cref="ToEnvVarFilePath(string)"/> can be safely invoked on this string to obtain a <see cref="IEnvVarFilePath"/>.
      ///</remarks>
      ///<param name="pathString">This string from which is determined the path validity.</param>
      ///<returns>
      ...
      ///</summary>
      ///<remarks>
      ///If this method returns true, the extension method <see cref="ToVariableFilePath(string)"/> can be safely invoked on this string to obtain a <see cref="IVariableFilePath"/>.
      ///</remarks>
      ///<param name="pathString">This string from which is determined the path validity.</param>
      ///<returns>
      ...
      #endregion IsValidFile Absolute/Relative/EnvVar/Variable
   }
}
